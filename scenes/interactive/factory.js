...
// To be able to do scene.add.food(...)
Phaser.GameObjects.GameObjectFactory.register('food', function (x, y, text, direction) {
	return new Food(this.scene, x, y, text, direction);
})
